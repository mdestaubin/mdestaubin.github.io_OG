...
void statsBar() {
  ...
  fill(255);  
  textAlign(LEFT);
  text( "DAY: " + dayCounter +"       POPULATION: " + currentPopulationSize + " / " + initialPopulationSize +"       PERCENT SICK: " + nf(percentSick, 2, 2)+"%", 12, height - 12);
  textAlign(CENTER);
  text("HEALTH ZONES: 2       HEALTH STAFF: 48", width/2,height-12);
  textAlign(RIGHT);
  text( " CLICK TO ADD SICK AGENT  ||  SPACE BAR TO RESET", width-23, height -12);
...
class Agent {
  ...
  void checkEnvironment(PImage healthZone )
  {
    ...
    /////////////////////////////////////////////////////////////////// Death Zones //////////////
 if (loc.x > 177 && loc.x < 182 && loc.y > 169 && loc.y <175) 
    {
      dead = true;
      fill(255, 0, 0,150);
      noStroke();
    ...
    if (loc.x > 1015 && loc.x < 1020 && loc.y > 639 && loc.y < 645 )
    {
      dead = true;
      fill(255, 0, 0,150);
      noStroke();
    ...
    if (loc.x > 600 && loc.x < 602 && loc.y > 397 && loc.y < 402 )
    {
      dead = true;
      fill(255, 0, 0,150);
      noStroke();
    ...
    if (loc.x > 1015 && loc.x < 1020 && loc.y > 169 && loc.y <175 )
    {
      dead = true;
      fill(255, 0, 0,150);
      noStroke();
    ...
    if (loc.x > 177 && loc.x < 182 && loc.y > 639 && loc.y < 645 )
    {
      dead = true;
      fill(255, 0, 0,150);
      noStroke();
