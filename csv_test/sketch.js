var table;
var ADM1Counts = [];
var maxCases, minCases, maxDeaths, minDeaths;
var margin = 250;
...
function loadData() {
    var numCases = table.getColumn("Cases");
    maxCases = 0;
    minCases = 10000;

    // what are the min and max values of the amount of floors?
    for(var i=0; i<numCases.length; i++){
      var casesCount = int(numCases[i]);
      if(casesCount >maxCases){
        maxCases = casesCount;
      }
      if(casesCount < minCases){
        minCases = casesCount;
        }
    }

  console.log("Max amount of Cases: " + maxCases);
  console.log("Min amount of Cases: " + minCases);
